...
internal class AutoGeneratedCompoundSupplier {
    ...
    public class TextCardScope : GeneratedKiraScope<TextCardScope.SupplierImplsScope>() {
        ...
        public class SupplierImplsScope(private val scope: TextCardScope) :
            GeneratedKiraScope.SupplierImplsScope() {
    ...
    public class EngineScope : GeneratedKiraScope<EngineScope.SupplierImplsScope>() {
        override val supplierImplsScope: SupplierImplsScope = SupplierImplsScope(this)
    ...
    @Test
    fun reassign_one_of_the_suppliers_with_the_new_impl_of_the_same_type(): Unit =
    ...
    @Test
    fun reassign_one_of_the_suppliers_with_the_new_impl_of_the_other_type(): Unit =
        with(composeTestRule) {
            val root = createRoot().modify {
     ...
     */
    @Test
    fun reassign_one_of_the_suppliers_with_the_new_impl_of_the_other_type_after_init(): Unit =
        with(composeTestRule) {
            val root = createRoot()
            setContent { KiraScreen(root) }
     ...
     */
    @Test
    fun reassign_one_of_the_suppliers_with_the_new_impl_of_the_other_type_after_init_maliciously(): Unit =
        with(composeTestRule) {
